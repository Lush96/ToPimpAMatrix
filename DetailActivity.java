...
public class DetailActivity extends Activity {
    ...
    public CDenseMatrix64F mMatrix;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMatrix = (CDenseMatrix64F) getIntent().getSerializableExtra(MainActivity.SERIALIZABLE_KEY);
        //mMatrix.print();
...
//        findViewById(R.id.activity_detail_click_view).setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                Intent intent = new Intent(DetailActivity.class,KeyboardActivity.class);
